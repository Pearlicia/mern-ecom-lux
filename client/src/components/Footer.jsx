  ...
  return (
    <Container>
        ...
        <Right>
            <Title>Contact</Title>
            <ContactItem>
                <Room style={{marginRight:"10px"}}/> 876 Main St. Suite 500 Nigeria
            </ContactItem>
            <ContactItem>
                <Phone style={{marginRight:"10px"}}/> +234 806-123-4565
            </ContactItem>
            <ContactItem>
                <MailOutline style={{marginRight:"10px"}}/> contact@pearlicia-lux.com
            </ContactItem>
